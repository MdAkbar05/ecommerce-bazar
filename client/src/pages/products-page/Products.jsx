...
const ProductsPage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row p-4 gap-6">
      ...
      {/* Products Section */}
      <div className="w-full bg-slate-50 p-6 rounded-lg shadow-sm flex flex-col gap-4 overflow-y-scroll h-[90vh]">
        {/* Header */}
        <div className="text-center text-2xl font-semibold text-gray-800 mb-6">
          <div className="text-orange-500">Explore Products</div>
        </div>
